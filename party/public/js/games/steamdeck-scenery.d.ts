...
export declare function paintHazard(ctx: unknown, rect: readonly number[], options: { live: number | boolean; armed?: number; time?: number; theme?: Theme }): void;
export declare function paintExit(ctx: unknown, rect: readonly number[], options?: { time?: number; urgent?: boolean; out?: number; total?: number }): void;
