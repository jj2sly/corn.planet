...
export const ERROR_MESSAGES = {
  ...
  INSUFFICIENT_CANON: "INSUFFICIENT CONTAINMENT MATERIAL: the CPI Database doesn't hold enough entities for this many agents.",
  ...
  ALREADY_HIGHEST: "You already hold the highest bid.",
  INSUFFICIENT_KERNELS: "You don't have enough Kernels for that bid.",
  COLLECTION_FULL: "Your collection is full. You can't bid on more bays.",
  AWARD_DUPLICATE: "Someone already created an award with that name.",
  AWARD_LIMIT: "You've already created your award. Edit it instead.",
  TRADE_UNAVAILABLE: "That role trade isn't available.",
